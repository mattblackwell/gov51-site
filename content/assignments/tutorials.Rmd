...
For each After the package has been installed, you should be able to find all of the tutorials for the course in the "Tutorials" tab in the top-right pane of RStudio. Scroll down to find a QSS tutorial and click "Start Tutorial" to launch a tutorial: 
