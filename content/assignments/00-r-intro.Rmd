---
title: "Problem Set 0: Getting Started with R, R Studio, Git, and Github"
author: "Gov 51"
date: 2020-09-02
---
...
Now, switch to RStudio. Go to the menu bar and hit "File > New Project". You can then choose what type of project to start. Since we're importing from Github, we'll use the "Version Control" option (it's the bottom of the list). In the next menu, choose "Git". Now, you can paste the URL in the "Repository URL" box and hit "Create Project". And now you'll have your project ready to go in RStudio. 
